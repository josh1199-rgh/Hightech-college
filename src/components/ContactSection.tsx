    ...
    <section id="contact" className="py-16 sm:py-24 bg-[#F8F9FD] text-slate-900 font-inter relative overflow-hidden">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 relative flex flex-col justify-center space-y-8 min-h-[520px]">
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            >
              <div className="flex items-center gap-5">
                ...
                <div className="w-13 h-13 rounded-full bg-[#E0241A] text-white flex items-center justify-center shrink-0 shadow-md">
